...
def mk_tree1(itt):
    ...
    cmds.setAttr(leaf_obj_color + ".baseColor", 0.13, .05, .15)
...
def mk_tree2(itt):
    ...
    leaf_obj_color = cmds.shadingNode('standardSurface', n=f"{PFX}tree3_{itt:02}_leaf_shd", asShader=1)
    cmds.setAttr(leaf_obj_color + ".baseColor", 0.07, .12, .18)
...
def mk_tree3(itt):
    ...
    cmds.select(f"{PFX}tree3_{itt:02}_leaf1.f[21]", f"{PFX}tree3_{itt:02}_leaf1.f[29]", f"{PFX}tree3_{itt:02}_leaf1.f[36]")
    cmds.move(-.7, 0, .55, r=1)
    cmds.scale(0.77, 1, 0.77)
    ...
    leaf_obj_color = cmds.shadingNode('standardSurface', n=f"{PFX}tree3_{itt:02}_leaf_shd", asShader=1)
    cmds.setAttr(leaf_obj_color + ".baseColor", 0.08, .16, .07)
...
def lights():
    ...
    cmds.connectAttr(physicalSkyShader + ".outColor", skydome + ".color")
